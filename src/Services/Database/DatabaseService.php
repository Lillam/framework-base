...
class DatabaseService extends Service
{
	...
	{
		$this->application->instance(ConnectionManagerInterface::class, (new ConnectionManager)
		...
		Model::setResolver($this->application->make(ConnectionManagerInterface::class));
